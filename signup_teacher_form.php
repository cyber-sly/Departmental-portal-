			<form id="signin_teacher" class="form-signin" method="post">
					...
					<input type="text" class="input-block-level" id="username" name="lecturer_id" placeholder="Lecturer ID" required>
			...
			jQuery("#signin_teacher").submit(function(e){
					...
					$.ajax({
						...
						if(html=='true')
						{
						$.jGrowl("Welcome to COMPSCI Portal", { header: 'Sign up Success' });
						var delay = 1000;
