<div class="span3" id="sidebar">
		...
		<ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
			<li class="active"><a href="register.php"><i class="icon-chevron-right"></i><i class="icon-group"></i>&nbsp;Register Course</a></li>
			<li class=""><a href="dashboard_student.php"><i class="icon-chevron-right"></i><i class="icon-group"></i>&nbsp;My Course</a></li>
			<li class="">
			...
			<a href="student_message.php"><i class="icon-chevron-right"></i><i class="icon-envelope-alt"></i>&nbsp;Message
			 ...
			 <li class=""><a href="backpack.php"><i class="icon-chevron-right"></i><i class="icon-suitcase"></i>&nbsp;School Bag</a></li>
		</ul>
