   <div class="row-fluid">
                            ...
                            <div class="block-content collapse in">
								...
								<!--
									...
									-->	
                                        ...
                                        <div class="control-group">
                                          <div class="controls">
                                            <input class="input focused" name="lecturer_id" id="focusedInput" type="text" placeholder = "Lecturer ID">
                                          </div>
                                        </div>
					    ...
					    <?php
                            if (isset($_POST['save'])) {
                                ...
                                mysqli_query($conn,"insert into teacher (lecturer_id,firstname,lastname,location,department_id)
								values ('$lecturer_id','$firstname','$lastname','uploads/NO-IMAGE-AVAILABLE.jpg','$department_id')         
								") or die(mysqli_error()); ?>
								<script>
