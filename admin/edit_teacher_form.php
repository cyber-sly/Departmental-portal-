   <div class="row-fluid">
       <a href="teachers.php" class="btn btn-info"><i class="icon-plus-sign icon-large"></i> Add Lecturer</a>
                        <!-- block -->
                        <div class="block">
                            ...
                            <div class="block-content collapse in">
								...
								<!--
									...
									?>
										...
										<div class="control-group">
                                          <div class="controls">
                                            <input class="input focused" value="<?php echo $row['lecturer_id']; ?>" name="lecturer_id" id="focusedInput" type="text" placeholder = "Lecturer ID">
                                          </div>
                                        </div>
				   ...
				   <?php
                            if (isset($_POST['update'])) {
								...
								$query = mysqli_query($conn,"select * from teacher where lecturer_id = '$lecturer_id' ")or die(mysqli_error());
								...
								mysqli_query($conn,"update teacher set lecturer_id = '$lecturer_id' , firstname = '$firstname' , lastname = '$lastname' , department_id = '$department_id' where teacher_id = '$get_id' ")or die(mysqli_error());	
